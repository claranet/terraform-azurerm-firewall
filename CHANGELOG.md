...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 04eda79

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 1de2051
* **deps:** update dependency tflint to v0.64.0 0207b50
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 1c49e0b
* **v9:** 🐛 synchronize common files and docs 533027b

## 8.0.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug 855295c

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 8b5faca
* **deps:** update dependency opentofu to v1.12.2 e0b9414
* **deps:** update dependency opentofu to v1.12.3 da1aefd
* **deps:** update dependency opentofu to v1.12.4 2be160e
* **deps:** update dependency tflint to v0.63.1 bd50ca9
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 6349679
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 74a3944

## 8.0.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 255706f

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 8cd0eec
* **deps:** update dependency opentofu to v1.11.7 85a4ae2
* **deps:** update dependency opentofu to v1.12.0 b99ca1d
* **deps:** update dependency terraform-docs to v0.23.0 55d7b3f
* **deps:** update dependency terraform-docs to v0.24.0 46d5b0f
* **deps:** update dependency tflint to v0.62.1 7fda601
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 eee0443
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 d9740cd
* **deps:** update tools f26d268
* **pre-commit:** 🔧 move to prek 8c43c51
* **tfdocs:** bump tfdocs to v0.22 🔧 40e5c3e

## 8.0.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ fd3158f

### Code Refactoring

* update module structure and Github actions 👷 be84a56

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 71ab5a6
* **deps:** 🔗 bump tflint rules version 685bc8c
* **deps:** update dependency trivy to v0.69.2 f23488e
* **deps:** update dependency trivy to v0.69.3 1183fc2
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 a57a893

## 8.0.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 8ae7c6c

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 f3ab147
* **deps:** update dependency opentofu to v1.11.2 0dbf369
* **deps:** update dependency opentofu to v1.11.3 fa5c45d
* **deps:** update dependency opentofu to v1.11.4 a1da2f2
* **deps:** update dependency opentofu to v1.11.5 574fff0
* **deps:** update dependency pre-commit to v4.4.0 1423f4f
* **deps:** update dependency pre-commit to v4.5.0 8e4498c
* **deps:** update dependency pre-commit to v4.5.1 78ce75a
* **deps:** update dependency tflint to v0.60.0 800a353
* **deps:** update dependency tflint to v0.61.0 670f183
* **deps:** update dependency trivy to v0.67.1 96e54a9
* **deps:** update dependency trivy to v0.67.2 98c81cc
* **deps:** update dependency trivy to v0.68.1 dc37d23
* **deps:** update dependency trivy to v0.68.2 18f5779
* **deps:** update dependency trivy to v0.69.0 7367d34
* **deps:** update dependency trivy to v0.69.1 8a5ac27
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 5c9e8a1
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 494220b
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 9dc1a13
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 a494288
* **deps:** update tools d2cec4f

## 8.0.1 (2025-09-30)

### Code Refactoring

* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 4f0b4d2

### Miscellaneous Chores

* **⚙️:** ✏️ update template identifier for MR review b4766ae
* 🗑️ remove old commitlint configuration files a786cf5
* **deps:** 🔗 bump AzureRM provider version to v4.31+ 1ea5211
* **deps:** update dependency claranet/diagnostic-settings/azurerm to ~> 8.1.0 c2d1d12
* **deps:** update dependency opentofu to v1.10.0 0666e84
* **deps:** update dependency opentofu to v1.10.1 ab39d52
* **deps:** update dependency opentofu to v1.10.3 b541ecf
* **deps:** update dependency opentofu to v1.10.6 b51365a
* **deps:** update dependency opentofu to v1.9.1 4e3e7c0
* **deps:** update dependency pre-commit to v4.2.0 3440702
* **deps:** update dependency terraform-docs to v0.20.0 57daa93
* **deps:** update dependency tflint to v0.57.0 b0e74b7
* **deps:** update dependency tflint to v0.58.0 01dfacf
* **deps:** update dependency tflint to v0.58.1 312d67d
* **deps:** update dependency tflint to v0.59.1 108af80
* **deps:** update dependency trivy to v0.59.1 02efb08
* **deps:** update dependency trivy to v0.60.0 371965a
* **deps:** update dependency trivy to v0.61.1 812c1ad
* **deps:** update dependency trivy to v0.62.0 92e00ef
* **deps:** update dependency trivy to v0.62.1 7209af7
* **deps:** update dependency trivy to v0.63.0 adb56e1
* **deps:** update dependency trivy to v0.66.0 3b23e4b
* **deps:** update dependency trivy to v0.67.0 8ba56df
* **deps:** update pre-commit hook alessandrojcm/commitlint-pre-commit-hook to v9.21.0 d35810c
* **deps:** update pre-commit hook alessandrojcm/commitlint-pre-commit-hook to v9.22.0 9d55a8f
* **deps:** update pre-commit hook pre-commit/pre-commit-hooks to v6 fdb670b
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.0 5c37a4d
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.1 e524fa5
* **deps:** update terraform claranet/diagnostic-settings/azurerm to ~> 8.2.0 e267097
* **deps:** update terraform claranet/subnet/azurerm to ~> 8.1.0 6dd3468
* **deps:** update tools daa5953
* **deps:** update tools ca5eb94
* **deps:** update tools 8b3229f
* **deps:** update tools 71fbf14
* **deps:** update tools d554cc1
* update Github templates dcf561b
